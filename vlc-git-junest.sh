...
APP=vlc-git
BIN="vlc"
DEPENDENCES="ca-certificates jre8-openjdk libaacs libbluray libbdplus libdvdcss libdvdnav libdvdread zvbi pipewire pulse libxtst libxi libvdpau nvidia-utils v4l"
...
LIBSAVED="pk p11 alsa jack pipewire pulse libaacs libbluray libbdplus libdvdcss libdvdnav libdvdread pipewire pulse libxtst libxi libvdpau v4l qt gl GL jvm nvidia-utils" # Enter here keywords or file/folder names to save in /usr/lib
