...
APP=vlc-git
BIN="vlc"
DEPENDENCES="ca-certificates jre8-openjdk libaacs libbluray libbdplus libdvdcss libdvdnav libdvdread zvbi pipewire pulse libxtst libxi libva libva-nvidia-driver v4l"
...
LIBSAVED="pk p11 alsa jack pipewire pulse libaacs libbluray libbdplus libdvdcss libdvdnav libdvdread pipewire pulse libxtst libxi v4l qt gl GL jvm libva libva-nvidia-driver" # Enter here keywords or file/folder names to save in /usr/lib
