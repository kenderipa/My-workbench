...
APP=lutris
BIN=$APP
DEPENDENCES="ca-certificates pipewire pulse cabextract curl gdk-pixbuf2 glib2 gobject-introspection-runtime gtk3 mesa-utils p7zip pango psmisc python python-cairo python-certifi dbus-python python-distro python-evdev python-gobject python-lxml python-moddb python-pillow python-requests python-urllib3 python-yaml unzip webkit2gtk-4.1 xdg-desktop-portal-gtk xorg-xrandr gamemode gvfs innoextract lib32-gamemode lib32-vkd3d lib32-vulkan-icd-loader python-protobuf vkd3d vulkan-icd-loader vulkan-tools wine xorg-xgamma"
...
SHARESAVED="certificates cabextract curl mesa-utils p7zip python unzip xdg-desktop-portal-gtk xorg-xrandr gamemode gvfs innoextract vkd3d vulkan-icd-loader vulkan-tools wine xorg-xgamma" # Enter here keywords or file/folder names to save in both /usr/share and /usr/lib
LIBSAVED="pk p11 alsa jack pipewire pulse gl GL gdk-pixbuf2 glib2 gobject-introspection-runtime gtk3 pango psmisc python-cairo python-certifi dbus-python python-distro python-evdev python-gobject python-lxml python-moddb python-pillow python-requests python-urllib3 python-yaml webkit2gtk-4.1 lib32-gamemode lib32-vkd3d lib32-vulkan-icd-loader python-protobuf" # Enter here keywords or file/folder names to save in /usr/lib
